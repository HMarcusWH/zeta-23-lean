...
from control_v2.router import action_score, load_actions, recommend
...
class ControlV2Tests(unittest.TestCase):
    ...
    def test_state_is_post_115_and_rh_open(self):
    ...
    def test_router_is_deterministic_and_non_authoritative(self):
        state = load_research_state()
