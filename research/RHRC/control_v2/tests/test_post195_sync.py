...
class Post195SyncTests(unittest.TestCase):
    ...
    def test_living_docs_advance_through_195(self):
        paths = (
            ROOT / "README.md",
            ROOT / "AUDIT.md",
            ROOT / "FORK_NOTES.md",
    ...
    def test_current_plan_moves_to_residual_orientation_mechanism(self):
        ...
        for token in (
            ...
            "one unresolved span",
            "63/64",
            "source-channel mechanism audit",
    ...
    def test_obs055_narrows_to_obs056(self):
