...
class FFBBPRHKGAssuranceTests(unittest.TestCase):
    ...
    def test_live_snapshot_produces_expected_ffbbp_separation(self):
        report = build_report()
        self.assertEqual(report["input_snapshot"]["candidate_count"], 2356)
        ...
        self.assertEqual(module_only["diagnostic_factorization"]["mixed_value_fiber_count"], 166)
        ...
        self.assertEqual(type_digest["decision_factorization"]["fiber_count"], 2324)
        ...
        self.assertEqual(selected["decision_factorization"]["fiber_count"], 513)
