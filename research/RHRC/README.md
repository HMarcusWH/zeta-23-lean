...
Start with the current programme:
- routes/R003_ccm_bridge/POST_247_RIEMANN_WEARING_GLASSES_PROGRAM.md — canonical Glasses v2 roadmap;
- RESEARCH_LEADS_POST_247_GLOBAL_BOTTOM_GLASSES_DELTA.md — complete post-green research pass;
...
## Post-#237 execution override

Current formal compression:
```text
off-line zero
  -> retained first-bad state
  -> cross-parity source/secular completion
  -> real source phase (#236)
  -> real completed-source corridor (#237)
  -> DERIVED retained real Gamma/alpha reduction
  -> NEXT: generic safe-shift conjugation / real transfer geometry
  -> OPEN: orient Gamma
```

Do not promote the derived Gamma identities to PROVED until Lean exports them. Do not infer Gamma positivity from reality alone. **RH remains OPEN.**
...
## Historical post-#227 research settlement
...
## Post-#211 authoritative theorem update
