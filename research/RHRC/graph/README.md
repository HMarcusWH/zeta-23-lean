...
## FFBBP assurance receipt

The repository also declares
`research/RHRC/ffbbp/generated/RHKG_CANDIDATE_REDUCTION_ASSURANCE.json` as an
externally generated graph-covered product. The producer is
`research/RHRC/ffbbp/rhkg_assurance.py`. RHKG records the file and producer but
does not include the generated bytes in the subject digest.

The report is a finite-snapshot reduction-assurance object, not a theorem or
mathematical implication edge.
