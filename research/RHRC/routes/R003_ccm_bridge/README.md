...
Status: **FINITE CLOSURE REACHED / D0 SETTLED / G0-A BASIS MAP REACHED / G1 NEXT**. RH remains **OPEN**.
...
4. **G1 — localized Weil restriction: NEXT.** Define the actual localized Weil quadratic form and prove or falsify that its restriction to the named finite Fourier space has matrix `cutoffFreeMatrix` under the exact production normalization.
