...
## Post-#247 falsification hierarchy
...
No synthetic or external control is a zeta counterexample unless exact realizability/equivalence is separately proved.


## Post-#237 countermodel firewall

The post-#237 real-phase collapse does not invalidate the historical generic countermodels. They still block promotion from “Gamma is real” to “Gamma has a universal positive sign,” and they still show that generic predecessor/parity/shell/displacement structure is insufficient for simultaneous-bad exclusion.

What changed is the *phase* question on the retained canonical state: #237 plus existing exact balances reduce it to a real transfer coefficient. Countermodels remain relevant to sign claims, not to the newly exposed conjugation-based reality route. **RH remains OPEN.**
