...
and, under `L,e,o>0`, the inherited orientation equivalence

```text
sign(P1') = sign(P2) = sign(J).
```

All six exact inherited centers have `e>0`, `o>0`, `J>0`, `P2>0`.

The finite-width first-order centered enclosure returns:
