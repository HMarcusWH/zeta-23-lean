...
This file formalizes the measurable-space construction underlying Theorem 3.1
...
Existence-and-uniqueness of the full path law is kept in `Theorem31.lean`; this
module owns only the typed one-step kernel, the Ionescu--Tulcea path law, and the
transition identities it satisfies.
-/
